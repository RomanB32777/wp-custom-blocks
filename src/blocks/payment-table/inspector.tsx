...
import {
	...
	type IPaymentTableBlockAttributes,
} from "./attributes";

const Inspector: FC<IInspectorProps<IPaymentTableBlockAttributes>> = ({
	attributes,
	setAttributes,
}) => {
		...
		<InspectorControls>
			...
			>
				<ColorControl
					...
					label={__("Head background color", "wp-custom-blocks")}
					{...colorControlProps}
				/>
				...
				<ColorControl
					...
					label={__("Body background color", "wp-custom-blocks")}
					{...colorControlProps}
				/>
